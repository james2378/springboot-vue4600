	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="民族" prop="minzu">
					<el-input v-model="ruleForm.minzu" placeholder="民族" clearable  :readonly="ro.minzu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="民族" prop="minzu">
					<el-input v-model="ruleForm.minzu" placeholder="民族" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="籍贯" prop="jiguan">
					<el-input v-model="ruleForm.jiguan" placeholder="籍贯" clearable  :readonly="ro.jiguan"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="籍贯" prop="jiguan">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="出生年月" prop="chushengnianyue">
					<el-date-picker
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.chushengnianyue" label="出生年月" prop="chushengnianyue">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="申请说明" prop="shenqingshuoming">
					<el-input v-model="ruleForm.shenqingshuoming" placeholder="申请说明" clearable  :readonly="ro.shenqingshuoming"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="申请说明" prop="shenqingshuoming">
					<el-input v-model="ruleForm.shenqingshuoming" placeholder="申请说明" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="upload" v-if="type!='info'&& !ro.shenqingwenjian" label="申请文件" prop="shenqingwenjian">
					<file-upload
						tip="点击上传申请文件"
						action="file/upload"
						:limit="1"
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.shenqingwenjian" label="申请文件" prop="shenqingwenjian">
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 15px","margin":"0 20px 0 0","outline":"none","color":"#000","borderRadius":"0","background":"url(http://codegen.caihongy.cn/20220727/34cf32af9b2e40ac9572071b85e16068.png) center center","width":"118px","lineHeight":"40px","fontSize":"14px","height":"43px"}' type="text" size="small" @click="download($base.url+ruleForm.shenqingwenjian)">下载</el-button>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="!ruleForm.shenqingwenjian" label="申请文件" prop="shenqingwenjian">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="介绍人" prop="jieshaoren">
					<el-input v-model="ruleForm.jieshaoren" placeholder="介绍人" clearable  :readonly="ro.jieshaoren"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="介绍人" prop="jieshaoren">
					<el-input v-model="ruleForm.jieshaoren" placeholder="介绍人" readonly></el-input>
				</el-form-item>
			</template>
		...
		init(id,type) {
			...
			this.$http({
				...
				if (data && data.code === 0) {
					...
					if(json.nianling!=''&&json.nianling && this.$storage.get("role")!="管理员"){
