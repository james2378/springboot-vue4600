<template>
  <div>
    <el-form
      ...
      label-width="100px"
    >
      <el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' label="选择考核试卷" prop="paperid">
        <el-select @change="onPaperChange" v-model="ruleForm.paperid" placeholder="选择考核试卷">
          <el-option
      ...
      <el-form-item :style='{"width":"100%","padding":"0","margin":"0"}'>
        <el-button :style='{"border":"0","cursor":"pointer","padding":"0","margin":"0 20px 0 0","outline":"none","color":"rgba(255, 255, 255, 1)","borderRadius":"0","background":"url(http://codegen.caihongy.cn/20220727/227fc20604bd464fb6d2f6d9aacc9c12.png) center center","width":"157px","lineHeight":"40px","fontSize":"14px","height":"43px"}' type="primary" @click="onSubmit">提交</el-button>
        <el-button :style='{"border":"0px solid rgba(64, 158, 255, 1)","cursor":"pointer","padding":"0","margin":"0","outline":"none","color":"#fff","borderRadius":"0","background":"url(http://codegen.caihongy.cn/20220727/227fc20604bd464fb6d2f6d9aacc9c12.png) center center","width":"157px","lineHeight":"40px","fontSize":"14px","height":"43px"}' @click="back()">取消</el-button>
      </el-form-item>
    </el-form>
...
export default {
  data() {
    ...
    return {
      ...
      rules: {
        paperid: [{ required: true, message: "请选择考核试卷", trigger: "blur" }],
        questionname: [
