		...
		<template v-if="showFlag">
			...
			<!-- <div> -->
				<el-table class="tables"
					...
					v-if="isAuth('yubeizhuanzheng','查看')"
					:data="dataList"
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column :resizable='true' :sortable='false' prop="zhuanzhengwenjian" label="转正文件">
						<template slot-scope="scope">
							<el-button v-if="scope.row.zhuanzhengwenjian" type="text" size="small" @click="download($base.url+scope.row.zhuanzhengwenjian)">下载</el-button>
                            <span v-else >无</span>
						</template>
					</el-table-column>
					...
					<el-table-column :resizable='true' :sortable='false' v-if="isAuth('yubeizhuanzheng','审核')" prop="sfsh" label="审核">
						<template slot-scope="scope">
    ...
    shDialog(row){
      ...
      if(row){
        this.shForm = {
          ...
          zhuanzhengwenjian: row.zhuanzhengwenjian,
          sfsh: row.sfsh,
          shhf: row.shhf,
          id: row.id
        }
