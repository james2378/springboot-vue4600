	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="upload" v-if="type!='info'&& !ro.zhuanzhengwenjian" label="转正文件" prop="zhuanzhengwenjian">
					<file-upload
						tip="点击上传转正文件"
						action="file/upload"
						:limit="1"
						:multiple="true"
						:fileUrls="ruleForm.zhuanzhengwenjian?ruleForm.zhuanzhengwenjian:''"
						@change="zhuanzhengwenjianUploadChange"
					></file-upload>
				</el-form-item>  
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.zhuanzhengwenjian" label="转正文件" prop="zhuanzhengwenjian">
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 15px","margin":"0 20px 0 0","outline":"none","color":"#000","borderRadius":"0","background":"url(http://codegen.caihongy.cn/20220727/34cf32af9b2e40ac9572071b85e16068.png) center center","width":"118px","lineHeight":"40px","fontSize":"14px","height":"43px"}' type="text" size="small" @click="download($base.url+ruleForm.zhuanzhengwenjian)">下载</el-button>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="!ruleForm.zhuanzhengwenjian" label="转正文件" prop="zhuanzhengwenjian">
...
export default {
	data() {
		...
		return {
			...
			rules: {
				...
				zhuanzhengwenjian: [
					{ required: true, message: '转正文件不能为空', trigger: 'blur' },
				],
				sfsh: [
				],
				shhf: [
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='zhuanzhengwenjian'){
							this.ruleForm.zhuanzhengwenjian = obj[o];
							this.ro.zhuanzhengwenjian = true;
							continue;
						}
				}
	...
	if(this.ruleForm.zhuanzhengwenjian!=null) {
		this.ruleForm.zhuanzhengwenjian = this.ruleForm.zhuanzhengwenjian.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `yubeizhuanzheng/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.yubeizhuanzhengCrossAddOrUpdateFlag = false;
						 this.parent.search();
    ...
    zhuanzhengwenjianUploadChange(fileUrls) {
	    this.ruleForm.zhuanzhengwenjian = fileUrls;
    },
  }
};
</script>
