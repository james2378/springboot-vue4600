<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="党员账号" prop="dangyuanzhanghao">
					<el-input v-model="ruleForm.dangyuanzhanghao" placeholder="党员账号" clearable  :readonly="ro.dangyuanzhanghao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="党员账号" prop="dangyuanzhanghao">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="党员姓名" prop="dangyuanxingming">
					<el-input v-model="ruleForm.dangyuanxingming" placeholder="党员姓名" clearable  :readonly="ro.dangyuanxingming"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="党员姓名" prop="dangyuanxingming">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="党员手机" prop="dangyuanshouji">
					<el-input v-model="ruleForm.dangyuanshouji" placeholder="党员手机" clearable  :readonly="ro.dangyuanshouji"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="党员手机" prop="dangyuanshouji">
					<el-input v-model="ruleForm.dangyuanshouji" placeholder="党员手机" readonly></el-input>
				</el-form-item>
			</template>
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='dangyuanshouji'){
							this.ruleForm.dangyuanshouji = obj[o];
							this.ro.dangyuanshouji = true;
							continue;
						}
				}
