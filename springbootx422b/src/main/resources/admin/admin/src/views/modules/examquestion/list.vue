      ...
      <el-form :style='{"margin":"0 0 20px"}' :inline="true" :model="searchForm" class="center-form-pv">
        <el-row :style='{"display":"block"}'>
			<div :style='{"margin":"0 10px 0 0","display":"inline-block"}'>
			  <label :style='{"margin":"0 10px 0 0","color":"#000","display":"inline-block","lineHeight":"40px","fontSize":"14px","fontWeight":"500","height":"40px"}' class="item-label">考核试卷</label>
			...
			<el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","outline":"none","color":"#000","borderRadius":"4px","background":"url(http://codegen.caihongy.cn/20220727/34cf32af9b2e40ac9572071b85e16068.png) center center","width":"118px","fontSize":"14px","height":"43px"}' round @click="search()">查询</el-button>
		</el-row>
        <el-row :style='{"margin":"20px 0","display":"flex"}'>
          <el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 0 0","outline":"none","color":"#000","borderRadius":"0","background":"url(http://codegen.caihongy.cn/20220727/34cf32af9b2e40ac9572071b85e16068.png) center center","width":"118px","fontSize":"14px","height":"43px"}' type="primary" @click="addOrUpdateHandler()" round>新增</el-button>
          <el-button
		     :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 0 0","outline":"none","color":"#000","borderRadius":"0","background":"url(http://codegen.caihongy.cn/20220727/34cf32af9b2e40ac9572071b85e16068.png) center center","width":"118px","fontSize":"14px","height":"43px"}'
          ...
          >
            <template slot-scope="scope">
              <el-button
                type="text"
                size="small"
				:style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 6px 0","outline":"none","color":"#000","borderRadius":"0","background":"url(http://codegen.caihongy.cn/20220727/34cf32af9b2e40ac9572071b85e16068.png) center center/cover","width":"99px","fontSize":"14px","height":"32px"}'
