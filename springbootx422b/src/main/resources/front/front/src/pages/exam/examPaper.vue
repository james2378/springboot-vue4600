...
<div :style='{"width":"1200px","padding":"20px","boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.302)","margin":"10px auto","position":"relative","background":"#fff"}'>
    <div class="section-title" :style='{"margin":"10px 0","color":"#333","textAlign":"center","background":"rgba(0,0,0,0)","fontSize":"20px","lineHeight":"54px","fontWeight":"600"}'>考核试卷</div>
    <el-table
      :data="tableData"
      style="width: 100%">
      <el-table-column
      ...
      <el-table-column label="操作" width="150">
        <template slot-scope="scope">
          <el-button
            type="success"
            size="mini"
            @click="handleExam(scope.$index, scope.row)">考核</el-button>
        </template>
      </el-table-column>
    </el-table>
