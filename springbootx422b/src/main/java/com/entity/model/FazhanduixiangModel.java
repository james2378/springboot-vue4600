 ...
 */
public class FazhanduixiangModel  implements Serializable {
	...
	public void setFazhanbaogao(String fazhanbaogao) {
		this.fazhanbaogao = fazhanbaogao;
	}
	
	/**
	 * 获取：发展报告
	 */
	public String getFazhanbaogao() {
		return fazhanbaogao;
	}
